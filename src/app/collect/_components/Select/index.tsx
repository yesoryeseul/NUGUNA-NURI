    ...
    <div className='mb-3 px-4 w-full flex justify-end'>
      <Select value={selectedValue} onValueChange={handleSelectChange}>
        ...
        <SelectContent>
          ...
          <SelectItem value='교육_체험'>교육/체험</SelectItem>
          <SelectItem value='국악'>국악</SelectItem>
          <SelectItem value='독주_독창회'>독주/독창회</SelectItem>
          <SelectItem value='무용'>무용</SelectItem>
          <SelectItem value='뮤지컬_오페라'>뮤지컬/오페라</SelectItem>
          <SelectItem value='연극'>연극</SelectItem>
          <SelectItem value='영화'>영화</SelectItem>
          <SelectItem value='전시_미술'>전시/미술</SelectItem>
          <SelectItem value='콘서트'>콘서트</SelectItem>
          <SelectItem value='클래식'>클래식</SelectItem>
          <SelectItem value='축제-문화_예술'>축제-문화/예술</SelectItem>
          <SelectItem value='축제-시민화합'>축제-시민화합</SelectItem>
          <SelectItem value='축제-자연_경관'>축제-자연/경관</SelectItem>
          <SelectItem value='축제-전통_역사'>축제-전통/역사</SelectItem>
